...
const variantClasses: Record<Variant, string> = {
  ...
  danger:
    "bg-red-600 text-slate-50 shadow-sm hover:bg-red-500 hover:shadow-md active:bg-red-700",
  glass:
    "border border-white/15 bg-white/5 text-slate-50 backdrop-blur-md hover:border-white/25 hover:bg-white/10 active:bg-white/15",
};
