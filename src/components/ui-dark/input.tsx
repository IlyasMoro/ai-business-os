...
const fieldBase =
  "block w-full rounded-md border border-slate-800 bg-slate-900/60 px-3 py-2 text-sm text-white outline-none transition-colors duration-150 placeholder:text-slate-500 hover:border-slate-700 focus:border-blue-500";
