export function AiTerminalPreview() {
  return (
    <div className="mx-auto w-full max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-black/60 text-left shadow-2xl shadow-black/40 backdrop-blur-xl">
