    ...
    <div className="max-w-3xl">
      <div className="flex items-start justify-between">
        <div>
          ...
          {customer.company && <p className="mt-1 text-slate-500">{customer.company}</p>}
        </div>
        ...
        <CardContent className="grid grid-cols-2 gap-4 text-sm">
          ...
          {customer.notes && (
            <div className="col-span-2">
              ...
              <p className="whitespace-pre-wrap text-slate-900">{customer.notes}</p>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <p className="mt-6">
        <Link href="/dashboard/crm" className="text-sm text-slate-500 hover:text-slate-700">
          ← Back to customers
        </Link>
      </p>
    </div>
