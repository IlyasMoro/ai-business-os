  ...
  return (
    <div className="-m-4 min-h-[calc(100%+2rem)] p-4 sm:-m-6 sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-slate-50 light:text-slate-900">Orders</h1>
      ...
      <div className="mt-6 rounded-2xl border border-white/[0.09] light:border-white/80 glass">
        {orders.length === 0 ? (
          <EmptyState
            ...
            description={q ? "Try a different search term, or clear it to see everything." : "Create an order to start selling to your customers."}
            action={q ? { href: "/dashboard/sales", label: "Clear search", variant: "secondary" } : { href: "/dashboard/sales/new", label: "New order" }}
          />
        ) : (
