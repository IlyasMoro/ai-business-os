...
export default async function AdminCompaniesPage({
  ...
  return (
    <div className="-m-4 min-h-[calc(100%+2rem)] bg-black p-4 sm:-m-6 sm:p-6">
      <h1 className="text-2xl font-semibold text-slate-50">Companies</h1>
      ...
      <div className="mt-6 overflow-x-auto rounded-2xl border border-white/[0.06] bg-[#111111]">
            ...
            {companies.map((company) => {
              ...
              return (
                <tr key={company.id} className="border-b border-white/[0.06] last:border-0">
                  ...
                  <td className="px-4 py-3 text-slate-300">{company.users.length}</td>
